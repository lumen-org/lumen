...
define(['lib/logger', 'd3', './PQL', './VisMEL', './ResultTable', './SplitSample', './ScaleGenerator', './ViewSettings'],
  function (Logger, d3, PQL, VisMEL, RT, S, ScaleGen, Settings) {
    ...
    function plot(pane, aggrRT, dataRT, uniDensityRT, biDensityRT, queryTable) {


      // build trace for plot

      // aggregation plot trace
      let aggr_trace = {
        type: 'scatter',
        x: aggregations.sepal_width,  // layout.rows[0]
        y: aggregations.sepal_length  //
      };
