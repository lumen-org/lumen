...
*Lumen* does so by providing an interactive web application for the visual exploration, comparison, and validation of probabilistic models together with its data. 
...
Subsequently, this model is made more complex in an iterative manner [@Gelman:2013; @Gabry:2019] until it suffices the expert's goals.
...
Users can drag'n'drop variables onto the visual channels of the Specification (middle-left).
...
However, they can of course be separated on different machines across a network.
...
In fact *Lumen* does not depend on any specificity of a particular model class and we regard this genericity as one of *Lumens* major features. 
